/*
 Modified from:
 https://github.com/JakeWharton/retrofit2-kotlin-coroutines-adapter/blob/master/src/main/java/com/jakewharton/retrofit2/adapter/kotlin/coroutines/CoroutineCallAdapterFactory.kt
 To hide Retrofit's Response class from outer layer
 */
/*
 ...
 */
package nz.co.warehouseandroidtest.network.adapter
 ...
 */
internal class CoroutineCallAdapterFactory private constructor() : CallAdapter.Factory() {
    companion object {
    ...
    private class BodyCallAdapter<T>(
        ...
        override fun adapt(call: Call<T>): Deferred<T> {
            ...
            call.enqueue(object : Callback<T> {
                ...
                override fun onResponse(call: Call<T>, response: RetrofitResponse<T>) {
    ...
    private class ResponseCallAdapter<T>(
        ...
        override fun adapt(call: Call<T>): Deferred<Response<T>> {
            ...
            call.enqueue(object : Callback<T> {
                ...
                override fun onResponse(call: Call<T>, response: RetrofitResponse<T>) {
                    deferred.complete(Response(response))
                }
            })
